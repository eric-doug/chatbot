<template>
  <div class="bg-gray-100 h-screen flex flex-col max-w-lg mx-auto">
    ...
    <div class="bg-white p-4 flex items-center">
      <input type="text" v-model="this.inputText" placeholder="Type your message..." class="flex-1 border rounded-full px-4 py-2 focus:outline-none">
...
export default {
  ...
  data() {
    return {
      ...
      messages: [
        { text: "你好", isMine: true },
        { text: "你好，我是ai chatbot，有什么我能帮助你的吗？", isMine: false },
      ],
